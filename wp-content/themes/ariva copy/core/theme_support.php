		...
		*/
		function themestudio_setup() {
			...
			if ( isset($ts_ariva) ) {
				global $ts_ariva;
				$args = array(
					'default-image' => $ts_ariva['menu_background_color']['background-image'],
				);
	...
	*/
	...
	if( !function_exists( 'ts_add_thumbnail_size' ) ) {
		...
		*/
		...
		$thumb_size['imgSize']['client-work'] = array('width'=>227,  'height'=>190);
	...
	?>
        ...
        <div class="media comment-item" id="comment-<?php comment_ID() ?>">
            ...
            <div class="media-body">
                ...
                <span class="media-date pull-left"><?php echo get_comment_date(); ?></span>
